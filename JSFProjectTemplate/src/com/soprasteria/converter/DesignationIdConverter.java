...
@FacesConverter("DesignationIdConverter")
public class DesignationIdConverter implements Converter{
	@Override
	public Object getAsObject(FacesContext cpntext, UIComponent comp,
			String value) {
		if (value.contains("a")) {
			FacesMessage msg = new FacesMessage("Error converting designation id.",
